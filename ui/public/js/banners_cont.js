...
$("#banners_busqueda .item a").click(function () {

    banner_id = $(this).attr('banner_busqueda_id');
    console.log( "click en banner " + banner_id );
    ...
    $.ajax({
        type: 'POST',
        url: 'http://gpautos.net/index.php/banners/guardar_click_busqueda',
        data: Banner_data,
...
$('#banners_busqueda .item').each( function () {
    banner_id_v = $(this).find("a").attr('banner_busqueda_id');
    // do something…8l
    ...
    $.ajax({
        type: 'POST',
        url: 'http://gpautos.net/index.php/banners/guardar_visualizacion_busqueda',
        data: Banner_data,
        success: function (data) {
            //  console.log(data);
        }
