...
class Carros_model extends CI_Model
{
    ...
    function asignar_carro($cliente){



	    $fecha = New DateTime();
        $datos = array(
            'crr_fecha'                => $fecha->format('Y-m-d'),
            'crr_contacto_nombre'      => $cliente['crr_contacto_nombre'],
            'crr_contacto_telefono'    => $cliente['crr_contacto_telefono'],
            'crr_contacto_email'       => $cliente['crr_contacto_email'],
            'crr_estatus'              => 'Asignado',
            'id_predio_virtual'        => $cliente['id_predio_virtual'],
            'crr_nombre_propietario'   => $cliente['crr_nombre_propietario'],
            'crr_telefono_propietario' => $cliente['crr_telefono_propietario'],
            'crr_vencimiento'          => $cliente['crr_vencimiento'],
