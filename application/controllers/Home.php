    ...
    public function test_filtro(){
        ...
        if($data['s_ubicacion'] == null){
         //   echo 'no hay ubicacion';
            ...
            $sesion_ubicacion = $this->uri->segment(3);
        }
        ...
        if($data['s_tipo'] == null){
           // echo 'no hay tipo';
            ...
            $sesion_tipo =$this->uri->segment(4);
        }
        ...
        if($data['s_marca'] == null){
            ...
            $sesion_marca = $this->uri->segment(5);
        }
        ...
        if($data['s_linea'] == null){
          //  echo 'no hay linea';
            ...
            $sesion_linea = $this->uri->segment(6);
        }
        ...
        if($data['s_transmision'] == null){
         //   echo 'no hay transmision';
            ...
            $sesion_transmision = $this->uri->segment(7);
        }
        ...
        if($data['s_combustible'] == null){
            ...
            $sesion_combustible = $this->uri->segment(8);
        }
        ...
        if($data['s_origen'] == null){
          //  echo 'no hau origen';
            ...
            $sesion_origen = $this->uri->segment(9);
        }
        ...
        if($data['s_precio'] == null){
          //  echo 'no hay precio';
            ...
            $sesion_precio = $this->uri->segment(10);
        }
        //modelo
        ...
        //    echo 'no hay modelo';
            ...
            $sesion_modelo = $this->uri->segment(11);
        }
       ...
       // echo '<hr>';
        ...
        //pagination
        $config = array();
        $config["base_url"] = base_url() . "index.php/home/test_filtro/".$data['s_ubicacion'].'/'.$data['s_tipo'].'/'.$data['s_marca'].'/'.$data['s_linea'].'/'.$data['s_transmision'].'/'.$data['s_combustible'].'/'.$data['s_origen'].'/'.$data['s_precio'].'/'.$data['s_modelo'];
