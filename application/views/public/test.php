...
<?php if ($carros) { ?>
	...
	$predio_select_options = array();
	foreach ($predios->result() as $predio) {
		$predio_select_options[$predio->id_predio_virtual] = $predio->prv_nombre;
	}
            ...
            <div class="row">
                <div class="col m3 s12">
                    <div id="homeSearchBox">
                        ...
                        <form method="post" action="<?php echo base_url(); ?>index.php/carro/por_predio">
                            <ul class="collapsible" data-collapsible="expandable">
                                <li>
                                    <div class="collapsible-header active"><i class="material-icons">directions_car</i>Predio
                                    </div>
                                    <div class="collapsible-body">
                                        <div class="row">
                                            <div class="col s12">
                                                <label for="tipo_carro">Predio</label>
	                                            <?php echo form_dropdown($predio_select, $predio_select_options) ?>
                                            </div>
                                            <div class="input-field col s12">
                                                <button type="button" class="btn btn-success btn-sm text-center orange darken-4 waves-effect waves-light" id="btn_predio">Buscar</button>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <form id="filtro_form">
                            ...
                            <div class="card ">
                                <div class="card-action">
                                    <button type="submit" class="btn btn-success btn-sm text-center orange darken-4 waves-effect waves-light">Buscar</button>
                                </div>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    $("#btn_predio").click(function () {
        var codigo_carro_a_buscar = $("#predio_select").val();
        if (codigo_carro_a_buscar == ''){
            console.log('codigo vacio ');
        }else{
            window.location.href = "<?php echo base_url();?>index.php/predio/ver/"+codigo_carro_a_buscar;
        }
    });
