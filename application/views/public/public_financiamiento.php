...
$que_vehiculo_n = array(
    'name' => 'que_vehiculo',
    'id' => 'que_vehiculo_n',
    'value' => 'no',
    'checked' => false,
);
$vehiculo_deseado = array(
    'type' => 'text',
    'name' => 'vehiculo_deseado',
    'id' => 'vehiculo_deseado',
    'class' => ' validate',
);
?>
            ...
            <div class="row">
                <div class="card">
                    <div class="card-content">
                        <img src="<?php echo base_url() ?>ui/public/images/banner/credito/creditos.jpg"
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="row">
                            <form class="col s12" action="<?php echo base_url() ?>/formularios/pre_calificacion"
                                  method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <?php echo form_input($numero_telefono); ?>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12 m3">
                                            ...
                                            <br>
                                            <p>
                                                <?php echo form_radio($que_vehiculo_s); ?>
                                                <label for="que_vehiculo_s" >Si</label>
                                                <?php echo form_radio($que_vehiculo_n); ?>
