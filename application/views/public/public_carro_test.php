                ...
                <div class="col s12 m12 l6">
                    ...
                    <div id="carousel-carro" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <?php //print_contenido($fotos_carro->result()); ?>
                            <?php if ($fotos_carro) { ?>
                                <?php $imagecount =1; ?>
                                <?php foreach ($fotos_carro->result() as $imagen) { ?>
                                    <?php
                                    if (file_exists('/home2/gpautos/public_html/web/images_cont/' . $imagen->nombre_imagen)) { ?>

                                        <div class="item <?php if ($imagecount ==1){ echo'active'; } ?>">
                                            <img src="<?php echo base_url() . 'web/images_cont/' . $imagen->nombre_imagen ?>"
                            ...
                            <div class="col s12 m6">
                                <div class="dr_chat">
                                    <a class="wts_btn waves-effect waves-light btn  z-depth-3"
                                       ...
                                       href="https://wa.me/502<?php echo $data_carro->crr_contacto_telefono ?>?text=<?php echo urlencode('Vi tu carro en gpautos, quisiera información del codigo: ' . $data_carro->id_carro . ' Marca: ' . $data_carro->id_marca . ' Linea: ' . $data_carro->id_linea . ' Modelo: ' . $data_carro->crr_modelo) ?>">
                                        Pedir información <img
