...
<?php $this->start('page_content') ?>
    ...
    <div class="container">
        <section>
            <h3 class="texto_centrado">Gracias por llenar Nuestra solicitud, en breve uno de nuestros asesores se pondrá en contacto.</h3>
        </section>
        <div class="divider"></div>
        <div class="section">
            <div class="row">
                <div class="card formulario_tarjetas">
                    <div class="card-content">
                        <div class="row">
                            <form class="col  s12" action="<?php echo base_url() ?>/formularios/guardar_interesados_tarjetas"
                                  method="post">
                                ...
                                <div class="row">
                                    <ul class="collection">
                                        <li class="collection-item">Tus datos serán enviados a las entidades bancarias
                                            para que realicen la precalificación.
                                        </li>
                                        <li class="collection-item">En caso tu crédito salga aprobado tienes 10 días
                                            para presentar la documentación física.
                                        </li>
                                        <li class="collection-item">Las entidades bancarias pueden llamar a tu numero de
                                            teléfono para verificar la veracidad de la informacion.
                                        </li>
                                        <li class="collection-item">Autorizo a las entidades bancarias para efectuar la
                                            precalificación solicitada.
                                        </li>
                                        <li class="collection-item">Autorizo a la empresa GPAUTOS,S.A para que envie mi
                                            informacion a las entidades bancarias para realizar la
