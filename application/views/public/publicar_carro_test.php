                            ...
                            <div class="container">
                                <form action="<?php echo base_url() ?>index.php/cliente/guardar_carro" method="post"
                                    ...
                                    <ul class="collapsible" data-collapsible="expandable">
                                        <li class="active">
                                            <div class="collapsible-header active"><i class="material-icons">drive_eta</i>Datos del carro</div>
                                                        ...
                                                        <div class="row">
                                                            <div class="input-field col s12 m12">
                                                                ...
                                                                <?php echo form_input($descripcion); ?>
                                                                        <label class="control-label">DESCRIPCIÓN DEL ANUNCIO</label>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="input-field col s12 m4">
                                        ...
                                        <li>
                                            <div class="collapsible-header"><i class="material-icons">expand_more</i>Mas detalles </div>
                                            <div class="collapsible-body">
                                        ...
                                        <li>
                                            <div class="collapsible-header active"><i class="material-icons">account_circle</i>Datos del anunciante</div>
