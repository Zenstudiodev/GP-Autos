...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item ">
            <a href="http://emotion.gt/" target="_blank">
                <img src="<?php echo base_url() ?>ui/public/images/banner/emotion.jpg" alt="...">
            </a>
        </div>
        <div class="item ">
            <a href="#" target="_blank">
                <img src="<?php echo base_url() ?>ui/public/images/banner/imeco.jpg" alt="...">
            </a>
        </div>
        <div class="item ">
