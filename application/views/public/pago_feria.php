...
$precio_feria_input = array(
    'type' => 'number',
    'name' => 'precio_feria_input',
    'id' => 'precio_feria_input',
    'class' => ' validate',
    'value' => '0',
    //'placeholder' => 'Nombre en la tarjeta',
    'required' => 'required',
            ...
            <div class="row">
                <div class="col m12">
                    <div class="card">
                        ...
                        <?php if(!$carro_id){?>
                            <div class="row">
                                <div class="input-field col s8">
                                    <?php echo form_input($codigo_de_carro); ?>
                                    <label for="nombre_facturacion">CODIGO DE CARRO</label>
                                </div>
                                <div class="input-field col s4">
                                    <button class="btn waves-effect waves-light" type="button" name="bt_check_carro" id="bt_check_carro">Pagar
                                        feria
                        ...
                        <form id="Metodo_pago" method="post" action="<?php echo base_url() ?>cliente/guardar_pago_en_linea_feria">
                                            ...
                                            <div class="card-panel grey lighten-3">
                                                ...
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        ...
                                                        <label for="nombre_facturacion">Nombre factura:</label>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        ...
                                                        <label for="nit_facturacion">NIT:</label>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <?php echo form_input($correo_facturacion); ?>
                                                        <label for="correo_facturacion">correo de notificacion</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-panel grey lighten-3">
                                                <h5>Datos de carro</h5>
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <?php echo form_input($precio_feria_input); ?>
                                                        <label for="nombre_facturacion">Precio para feria</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <h5>Datos de pago</h5>
                                            ...
                                            <table class="striped table-bordes">
                                                ...
                                                <?php if ($precio_feria) { ?>
                                                    ...
                                                    <span id="anuncio_precio_feria">
                                                        Q.<?php echo $precio_feria->parametro_valor; ?>
                                                    </span>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
...
<script>
    ...
    $("#codigo_carro").change(function() {
       var codigo_carro = $(this).val();
       console.log(codigo_carro);
        $("#bt_check_carro").hide();
        $.ajax({
            type: 'GET',
            dataType: 'json',
            url: '<?php echo base_url()?>Carro/verificar_codigo_carro?carro_id=' + codigo_carro,
            success: function (data) {
               console.log(data);

               if (data == true){
                   console.log('pagar feria');
                   $("#bt_check_carro").show();
                   $("#bt_check_carro").click(function () {
                       console.log('redirect');
                       window.location.replace("<?php echo base_url()?>carro/pagar_feria/"+codigo_carro);

                   });

               }else{
                   $("#bt_check_carro").hide();
                   Materialize.toast('El código que ingreso no esta disponible para feria', 4000) // 4000 is the duration of the toast
               }
            }
        });
    });
