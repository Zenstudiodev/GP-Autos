            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content ">
                        <form action="<?php echo base_url() . 'index.php/admin/guardar_usuario' ?>" method="post"
                              class="form-horizontal">
                            <div class="form-group">
                                <label for="nombre" class="col-md-2 control-label">Username</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" placeholder="Userename" id="username" name="username"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" placeholder="Carros activos" id="carro_activos" name="carro_activos" value="0"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="carro_premitidos" class="col-sm-2 control-label">Carros Permitidos</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" placeholder="Carros permitidos" id="carro_premitidos" name="carro_permitidos"/>
                                </div>
                            </div>
                            <div class="form-group">
